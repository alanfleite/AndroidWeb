    ...
    try{
		...
		conexao = DriverManager.getConnection(url, usuario, senha);
			...
			if (n==0){
				...
				resultset2 = statement2.executeQuery("select USUARIO, RAZAO, CNPJ, PARCELAATRAZO, DESCIDA from CAD_CLI where USUARIO is not null order by USUARIO");
...
//					 String cidade = resultset1.getString("atendecidade");
					...
					statement2 = conexao.createStatement();
					resultset2 = statement2.executeQuery("select USUARIO, RAZAO, CNPJ, PARCELAATRAZO, DESCIDA from CAD_CLI where DESCIDA='" 
